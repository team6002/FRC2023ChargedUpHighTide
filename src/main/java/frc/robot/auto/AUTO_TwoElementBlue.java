...
public class AUTO_TwoElementBlue extends SequentialCommandGroup {
  public AUTO_TwoElementBlue(AUTO_Trajectories p_trajectories, SUB_Drivetrain p_drivetrain, SUB_Elbow p_elbow, SUB_Elevator p_elevator,
