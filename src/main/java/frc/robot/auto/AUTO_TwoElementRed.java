...
public class AUTO_TwoElementRed extends SequentialCommandGroup {
  public AUTO_TwoElementRed(AUTO_Trajectories p_trajectories, SUB_Drivetrain p_drivetrain, SUB_Elbow p_elbow, SUB_Elevator p_elevator,
