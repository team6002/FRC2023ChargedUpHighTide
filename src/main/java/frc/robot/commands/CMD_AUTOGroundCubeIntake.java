...
public class CMD_AUTOGroundCubeIntake extends SequentialCommandGroup {
  /** Creates a new GroundIntake. */
  public CMD_AUTOGroundCubeIntake(SUB_Intake p_intake, SUB_Elbow p_elbow, SUB_Elevator p_elevator, SUB_FiniteStateMachine p_finiteStateMachine) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new SequentialCommandGroup(
          new CMD_ElbowSetPosition(p_elbow, ElbowConstants.kElbowHalfwaydown),
          new WaitCommand(.1),
