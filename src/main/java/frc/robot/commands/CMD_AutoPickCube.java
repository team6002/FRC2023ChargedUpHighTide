...
public class CMD_AutoPickCube extends CommandBase {
  ...
  public CMD_AutoPickCube(SUB_IntakeCamera p_intakeCam, SUB_Drivetrain p_drivetrain, GlobalVariables p_variables) {
