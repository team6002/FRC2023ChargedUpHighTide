...
public class CMD_GroundConeDownIntake extends SequentialCommandGroup {
  ...
  public CMD_GroundConeDownIntake(SUB_Intake p_intake, SUB_Elbow p_elbow, SUB_Elevator p_elevator, SUB_FiniteStateMachine p_finiteStateMachine) {
    ...
    addCommands(
      ...
      new CMD_ElbowSetPosition(p_elbow, ElbowConstants.kElbowGroundConeDown)
