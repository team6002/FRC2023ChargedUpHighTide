...
public class CMD_Place3rdCubeLevel extends SequentialCommandGroup {
  /** Creates a new GroundIntake. */
  public CMD_Place3rdCubeLevel(SUB_Intake p_intake, SUB_Elbow p_elbow, SUB_Elevator p_elevator, SUB_FiniteStateMachine p_finiteStateMachine, GlobalVariables p_variables) {
