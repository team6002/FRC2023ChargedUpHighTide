...
public class CMD_ShelfConeIntake extends SequentialCommandGroup {
  /** Creates a new GroundIntake. */
  public CMD_ShelfConeIntake(SUB_Intake p_intake, SUB_Elbow p_elbow, SUB_Elevator p_elevator, SUB_FiniteStateMachine p_finiteStateMachine) {
